    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-cog', 'Engrenagem'), ('lni-layers', 'Design'), ('lni-leaf', 'Eco')], max_length=20, verbose_name='Ícone')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('titulo', models.CharField(max_length=20, verbose_name='Título')),
                ('descricao', models.TextField(max_length=100, verbose_name='Descrição')),
                ('icone', models.CharField(choices=[('lni-leaf', 'Eco'), ('lni-laptop-phone', 'Celular'), ('lni-rocket', 'Foguete')], max_length=20, verbose_name='Ícone')),
            ],
            options={
